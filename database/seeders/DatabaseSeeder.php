...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $catBaju = Category::create(['name' => 'Baju', 'code' => 'BJ']);
        $catCelana = Category::create(['name' => 'Celana', 'code' => 'CL']);
        $catElektronik = Category::create(['name' => 'Elektronik', 'code' => 'EL']);
        $catAksesoris = Category::create(['name' => 'Aksesoris', 'code' => 'AK']);
        // --- 5. Seed Satuan (Unit) ---
        $unitPcs = Unit::create(['name' => 'Pcs', 'code' => 'PCS']);
        $unitBox = Unit::create(['name' => 'Box', 'code' => 'BOX']);
        $unitLusin = Unit::create(['name' => 'Lusin', 'code' => 'LSN']);
        // --- 6. Seed Ukuran (Size) ---
        $sizeS = Size::create(['name' => 'S', 'code' => 'S']);
        $sizeM = Size::create(['name' => 'M', 'code' => 'M']);
        $sizeL = Size::create(['name' => 'L', 'code' => 'L']);
        $sizeAll = Size::create(['name' => 'All Size', 'code' => 'ALL']);

        $supplierA = Supplier::create([
            'name' => 'Supplier A',
            'phone' => '08123456789',
            'address' => 'Jakarta',
            'status' => Supplier::STATUS_ACTIVE, // Asumsi 1 = Aktif
            'type' => Supplier::TYPE_ONLINE,
            'description' => 'Supplier utama baju'
        ]);
        Product::create([
