...
const restoreBrand = (row) => {
    isActionLoading.value = true; // Nyalakan loader

    router.put(
        route("api.settings.restoreBrand", { id: row.id }),
        {},
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    >
        ...
        >
            <div>
                ...
                >
                    Kelola semua merk untuk produk.
                </p>
        ...
        <DataTable
            ref="datatable"
            :serverSide="true"
            :endpoint="route('api.settings.getBrand')"
            :columns="columns"
