...
const restoreSize = (row) => {
    isActionLoading.value = true; // Nyalakan loader

    router.put(
        route("api.settings.restoreSize", { id: row.id }),
        {},
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    >
        ...
        >
            <div>
                ...
                >
                    Kelola semua ukuran untuk produk.
                </p>
        ...
        <DataTable
            ref="datatable"
            :serverSide="true"
            :endpoint="route('api.settings.getSize')"
            :columns="columns"
