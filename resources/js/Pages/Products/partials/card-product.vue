...
<template>
    <div
        class="flex flex-col items-start max-w-4xl gap-4 p-3 mx-auto bg-gray-200 border-2 rounded-lg shadow-md bg-opacity-35 border-lime-500 sm:flex-row sm:items-center"
    >
        ...
        <!-- Gambar + Status -->
        <div
            class="flex flex-col justify-end w-24 rounded-md h-28 sm:w-28 sm:h-32"
        >
            <img
                alt="Produk"
            ...
            />
            <div
                class="py-1 text-xs font-medium text-center text-white bg-green-400 select-none rounded-b-md"
            >
                Aktif
            </div>
        </div>
        ...
        <div class="flex-1 space-y-3">
            <h2 class="text-lg font-bold leading-tight sm:text-xl">Produk A</h2>
            <p class="text-sm text-black sm:text-base">
                Oli Mesin Motor Matic dengan SAE 20/40 Isi 800 ML
            </p>
            <div class="flex flex-wrap gap-2">
                <span
                    class="px-3 py-1 text-xs font-medium text-black bg-white rounded-full select-none sm:text-sm"
                >
                    Oli
                </span>
                <span
        ...
        <!-- Harga & Aksi -->
        <div
            class="flex flex-col items-start w-full gap-3 sm:w-auto sm:items-end"
        >
            <!-- Persentase -->
            <div
                class="flex items-center gap-1 px-3 py-1 text-xs font-semibold text-red-600 bg-white rounded-full select-none"
            >
                <svg
                    width="20"
                    height="20"
            ...
            <div class="text-left sm:text-right">
                <p class="mb-0 text-sm text-black line-through opacity-60">
                    Rp 40.000
                </p>
                <p
                    class="text-xl font-extrabold leading-none text-black sm:text-2xl"
                >
                    Rp 50.000
                </p>
            </div>
