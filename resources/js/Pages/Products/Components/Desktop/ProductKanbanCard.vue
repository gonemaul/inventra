        ...
        <div class="flex gap-2.5">
            ...
            >
                ...
                <div
                    ...
                    class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-lime-50 to-lime-100 dark:from-gray-700 dark:to-gray-800 p-1"
                >
                    <span class="text-[9px] font-bold text-center text-gray-500 dark:text-gray-400 line-clamp-2 break-words select-none leading-tight">{{ data.name }}</span>
                </div>
            </div>
