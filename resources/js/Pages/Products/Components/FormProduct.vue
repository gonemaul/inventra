...
<template>
    ...
    <Deferred :data="requiredData">
                ...
                >
                    ...
                    <div class="grid grid-cols-2 gap-4 md:grid-cols-3">
                        <div
                            v-for="i in 6"
                            :key="i"
                            :class="{ 'col-span-2 md:col-span-1': i === 1 }"
                        >
                            <div
        ...
        >
                ...
                >
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <div class="relative">
                                <span
                                    class="absolute text-sm text-gray-500 left-3 top-2.5"
                                    >Rp</span
                                >
                                <TextInput
                    ...
                    <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                        <div>
                            <label
                                class="block mb-1 text-xs font-medium text-gray-500 uppercase"
                                >Margin (Rp)</label
                            >
                            <TextInput
            ...
            <div
                class="z-10 flex justify-end gap-3 p-4 bg-white border-t border-gray-200 md:p-6 dark:border-gray-700 dark:bg-customBg-tableDark"
            >
