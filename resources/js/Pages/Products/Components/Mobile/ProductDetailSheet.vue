    ...
    <div class="flex flex-col h-full bg-white dark:bg-gray-800">
        ...
        <div class="flex gap-4 border-b border-gray-100 dark:border-gray-700">
            ...
            >
                ...
                <div
                    v-if="!data.image_url"
                    class="absolute inset-0 z-0 flex flex-col items-center justify-center w-full h-full bg-gradient-to-br from-lime-50 to-lime-100 dark:from-gray-700 dark:to-gray-800 p-1"
                >
                    <span class="text-[8px] font-bold text-center text-gray-500 dark:text-gray-400 line-clamp-3 break-words select-none leading-tight">{{ data.name }}</span>
                </div>
            </div>
