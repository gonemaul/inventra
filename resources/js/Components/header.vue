...
<template>
    <header
        :class="showSidebar ? 'pl-20' : ''"
        class="flex items-center justify-between h-16 p-4 bg-white border-b-2 shadow-2xl text-customText-light border-borderc-light lg:pl-4 dark:bg-customBg-dark dark:text-customText-dark dark:border-borderc-dark"
    >
        ...
        <button
            ...
            id="menu-toggle"
            @click="toggleSidebar"
            :class="showSidebar ? 'fixed' : 'hidden'"
            class="z-50 p-2 rounded-md shadow bg-lime-500 dark:bg-white top-3 left-4 lg:hidden"
        >
            <svg
